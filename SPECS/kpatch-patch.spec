...
%define kernel_ver	4.18.0-193.28.1.el8_2
...
%changelog
* Thu Oct 22 2020 Joe Lawrence <joe.lawrence@redhat.com> [0-1.el8]
- An empty patch to subscribe to kpatch stream for kernel-4.18.0-193.28.1.el8_2 [1889368]

* Mon Oct 19 2020 Yannick Cote <ycote@redhat.com> [0-0.el8]
- An empty patch to subscribe to kpatch stream for kernel-4.18.0-193.28.1.el8_2 [1889368]
